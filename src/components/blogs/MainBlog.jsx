export default function MainBlog(){
      ...
      <div className="main-blog-content d-flex flex-column rounded-2">
            ...
            <div className="blog-item-date d-flex">
                  ...
                  <div className="main-blog-read-time d-flex flex-row justify-content-center align-items-center fw-light"><img src="/src/icons/blogs/timer.svg" alt="" className="timer-icon" />3 min read</div>
            </div>
