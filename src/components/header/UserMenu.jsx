...
const UserMenu = () =>{
      return(
            ...
            <ul>
                <li><img src="src/icons/user-menu/profile-circle.svg" alt="Mobile Phones" className='products-menu-icon'/><a href="#"><span className='userMenu__name'>Adnan Al-Ezari</span> <br/> <span className='userMenu__email'>adnan30062000@gmail.com</span></a></li>
