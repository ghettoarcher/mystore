        ...
        <div className="hotdeals-content d-flex flex-row justify-content-between">
          <div className="presale d-flex flex-row rounded-2 ">
            <div className="presale-title-wrapper d-flex flex-column p-4 position-relative">
              <img
                src="src/img/hotdeals/circle.svg"
                alt=""
                className="circle1"
              />
              <img
              ...
              <div className="presale-title fs-4 fw-normal z-2">
                {" "}
                <span>Iphone</span> 15 Series
              </div>
              <img
                className="presale-img z-2"
                src="/src/assets/images/iphone.svg"
                alt=""
              />
            ...
            <div className="presale-info d-flex flex-column position-relative pt-5 gap-4">
              ...
              <div className="presale-text">
                <div className="presale-subtitle text-center fw-normal">
                  It feels good to be the first
                </div>
                <div className="presale-description fw-light fs-6">
              ...
              <div className="button btn fs-6 fw-normal py-2 px-3 rounded-2">
                Register Now
              </div>
            </div>
          </div>
